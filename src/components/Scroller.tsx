...
export default function Scroller(){
    ...
    return <>
        ...
        <div className="flex flex-col gap-12 lg:gap-28 md:gap-20 md:pl-5">
            <div className="text-2xl pl-5 text-center md:text-left lg:text-left text-[#453C89] max-w-72 font-bold">Features Designed for 
                <span className="text-[#F47C8B]"> India’s SMBs</span> 
            </div>
            <div className="flex md:gap-7 lg:gap-8 gap-3 items-center">
                ...
                <div className="cursor-pointer flex flex-col gap-20 lg:pb-14 " onClick={()=>{setScrollNumber(curr=>curr+1)}}>
